...
function plot(f, t) {
    ...
    if (document.getElementById("district").checked == false) {
        d3.json("https://cs498finalproject.s3.us-east-2.amazonaws.com/states.json", function (json) {
        ...
        d3.json("https://cs498finalproject.s3.us-east-2.amazonaws.com/districts.json", function (json) {
            if ((f[0] > t[0] && f[1] <= t[1])) {
                alert("Select only between Jan 1993 and  Dec 2013");
                location.reload();
                return false;
